...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"src/scroll.js":[function(require,module,exports) {
"use strict";
...
var handleScrollContainersStyles = function handleScrollContainersStyles() {
...
var handleDocumentBodySettings = function handleDocumentBodySettings() {
  if (scrollable) {
    var scrollableBounds = scrollable.getBoundingClientRect();
    var documentHeight = "".concat(scrollableBounds.height, "px");
...
var smoothScroller = function smoothScroller() {
  ...
  scroll.target = _gsap.default.utils.clamp(0, scroll.limit, scroll.target);
  ...
  if (scrollable) {
    scrollable.style.transform = "translateY(".concat(-scroll.current, "px)");
  }
...
},{"gsap":"node_modules/gsap/index.js"}],"src/index.js":[function(require,module,exports) {
"use strict";

require("./styles.scss");

require("./scroll");
},{"./styles.scss":"src/styles.scss","./scroll":"src/scroll.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
